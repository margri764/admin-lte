...
@Component({
  selector: 'app-web-masters',
  templateUrl: './web-masters.component.html',
  styleUrls: ['./web-masters.component.css']
})
export class WebMastersComponent implements OnInit, OnDestroy {
  ...
  isDtInitialized:boolean = false;
    ...
    getInitialData(){
      ...
      this.userService.getWebmasters().subscribe( 
        ( {success, users} )=>{
